...
def main():
	...
	def redraw_window():
		...
		enemies_remaining_label = main_font.render(f"Enemies: {len(enemies)}", 1, WHITE)


		WIN.blit(lives_label, (10, 10))
		WIN.blit(level_label, (WIDTH - level_label.get_width() - PADDING, PADDING))
		WIN.blit(enemies_remaining_label, (WIDTH - enemies_remaining_label.get_width() - PADDING, enemies_remaining_label.get_height() + PADDING))
